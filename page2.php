        ...
        <div class="row">
            ...
            <div class="col-xl-9 col-lg-8 col-md-7">
                    ...
                    <div class="row">
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo '<a href="cart.php" class="social-info">';
                ...
                <div class="pagination">
                    ...
                    if ($total_pages > 1) {
                        if ($page > 1) {
                            echo '<a href="page2.php?page=' . ($page - 1) . '" class="prev-arrow"><i class="fa fa-long-arrow-left" aria-hidden="true"></i></a>';
                        }
                        for ($i = 1; $i <= $total_pages; $i++) {
                            if ($i == $page) {
                                echo '<a href="page2.php?page=' . $i . '" class="active">' . $i . '</a>';
                            } else {
                                echo '<a href="page2.php?page=' . $i . '">' . $i . '</a>';
                            }
                        }
                        if ($page < $total_pages) {
                            echo '<a href="page2.php?page=' . ($page + 1) . '" class="next-arrow"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>';
                        }
                    }
                    ?>
                </div>
